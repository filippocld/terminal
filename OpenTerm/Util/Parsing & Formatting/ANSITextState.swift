...
private let colors: [(r: Int, g: Int, b: Int)] = [
	...
	(0xC2, 0x36, 0x21), /* Red     */
	(0x25, 0xBC, 0x24), /* Green   */
	(0xAD, 0xAD, 0x27), /* Brown   */
	(0x49, 0x2E, 0xE1), /* Blue    */
	(0xD3, 0x38, 0xD3), /* Magenta */
	(0x33, 0xBB, 0xC8), /* Cyan    */
	(0xCB, 0xCC, 0xCD), /* White   */

	/* Intense colors */
	(0x81, 0x83, 0x83), /* Black   */
	(0xFC, 0x39, 0x1F), /* Red     */
	(0x31, 0xE7, 0x22), /* Green   */
	(0xEA, 0xEC, 0x23), /* Brown   */
	(0x58, 0x33, 0xFF), /* Blue    */
	(0xF9, 0x35, 0xF8), /* Magenta */
	(0x14, 0xF0, 0xF0), /* Cyan    */
	(0xE9, 0xEB, 0xEB), /* White   */
]
